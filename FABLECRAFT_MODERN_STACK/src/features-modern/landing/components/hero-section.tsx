  ...
  return (
    <section
      className={cn(
        ...
        isCompact ? 'py-8 sm:py-12 lg:py-16' : 'py-16 sm:py-20 lg:py-24',
        className
      )}
    ...
    >
      ...
      <div className='text-center space-y-6 lg:space-y-8 max-w-5xl mx-auto'>
        <div className='space-y-6 lg:space-y-8'>
          ...
          <div className='inline-flex items-center space-x-3 px-4 py-2 rounded-full bg-card/90 backdrop-blur-sm border border-border shadow-lg hover:shadow-xl transition-all duration-300'>
            <div
              ...
              aria-hidden='true'
            />
            <span className='text-xs sm:text-sm font-semibold text-foreground uppercase tracking-wide leading-tight'>
          ...
          <h1
            id='hero-heading'
            className={cn(
              'font-black text-foreground leading-[1.1] tracking-tight drop-shadow-sm',
              isCompact
          ...
          >
            From the first spark of an idea to the final polished manuscript.
            Craft novels, screenplays, and graphic novels with AI that
            understands the art of storytelling. Your imagination, amplified by
            intelligence.
          </p>

          {/* Enhanced Action Buttons with Improved Responsive Design */}
          <div className='flex flex-col sm:flex-row gap-4 pt-6 justify-center items-center max-w-lg mx-auto sm:max-w-none'>
            <Button
              size='lg'
              onClick={onNewProject}
              className={cn(
                'group relative w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground',
                'px-8 py-4 text-base sm:text-lg font-semibold shadow-lg hover:shadow-xl',
            ...
            <Button
              ...
              className={cn(
                ...
                'px-8 py-4 text-base sm:text-lg font-semibold shadow-md hover:shadow-lg',
                'rounded-xl transition-all duration-300 hover:scale-105 hover:-translate-y-0.5',
                'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2'
              )}
