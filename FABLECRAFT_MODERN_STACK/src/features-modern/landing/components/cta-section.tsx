      ...
      <div className={backgroundClasses}>
        ...
        {!isMinimal && (
          <>
            ...
            />
            <div
              className='absolute bottom-6 left-6 w-20 h-20 bg-accent/10 rounded-full blur-xl'
              aria-hidden='true'
            />
          </>
        )}
          ...
          {variant === 'default' && (
            <div className='pt-6 border-t border-border/50 mt-8'>
              <p className='text-sm text-muted-foreground'>
                <span className='font-medium'>Free to start</span> • No credit
                card required •<span className='font-medium'> Full access</span>{' '}
                to core features
              </p>
            </div>
          )}
