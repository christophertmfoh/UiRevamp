...
const defaultProcessSteps: ProcessStep[] = [
  ...
  },
  {
    ...
    detail:
      'Generate storyboards, concept art, and character designs from your written content',
  ...
  },
  {
    ...
    detail:
      'Publish across platforms, build communities, and collaborate with creators worldwide',
    ...
    >
      <div className='text-center'>
        ...
        <div className='flex flex-col items-center'>
          ...
          >
            Follow our proven 6-stage multimedia production process used by
            creative professionals worldwide. Each stage builds seamlessly into
            the next, ensuring your creative vision stays consistent from
        ...
        <div
          className='relative mt-acquaintances'
          role='list'
