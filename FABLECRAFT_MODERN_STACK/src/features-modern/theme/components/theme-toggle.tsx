...
const themeConfig: Record<Theme, ThemeConfig> = {
  ...
  'sunset-coral': {
    icon: Sun,
    label: 'Sunset Coral',
    description: 'Warm coral and gold',
  },
  'lavender-dusk': {
    icon: Sun,
    label: 'Lavender Dusk',
  ...
  netrunner: {
    icon: Zap,
    label: 'Netrunner',
    description: 'Electric yellow and cyan',
  },
  'dragons-hoard': {
    icon: Moon,
...
const classicLightThemes: readonly Theme[] = [
  'arctic-focus',
  'golden-hour',
] as const;
const classicDarkThemes: readonly Theme[] = [
  'midnight-ink',
  'forest-manuscript',
  'starlit-prose',
  'coffee-house',
] as const;
const modernLightThemes: readonly Theme[] = [
  'sunset-coral',
  'lavender-dusk',
  'moonlit-garden',
] as const;
const modernDarkThemes: readonly Theme[] = [
  'cherry-lacquer',
  'dragons-hoard',
] as const;
