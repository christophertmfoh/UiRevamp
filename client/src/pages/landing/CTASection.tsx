...
export function CTASection({ onNewProject, onNavigateToProjects }: CTASectionProps) {
  return (
    <section className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 py-20 sm:py-24 lg:py-32">
      <div className="relative overflow-hidden rounded-[3rem] bg-gradient-to-br from-card/80 via-card/60 to-card/40 border border-border shadow-2xl">
        {/* Background texture */}
        ...
        {/* Floating elements */}
        <div className="absolute top-8 right-8 w-32 h-32 bg-gradient-to-br from-primary/20 to-secondary/10 rounded-full blur-2xl"></div>
        <div className="absolute bottom-8 left-8 w-24 h-24 bg-gradient-to-br from-secondary/20 to-accent/10 rounded-full blur-xl"></div>
        ...
        <div className="relative z-10 text-center space-y-8 sm:space-y-12 p-8 sm:p-12 lg:p-16">
          <div className="space-y-8">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold gradient-primary-text">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 lg:gap-8 justify-center">
            <Button 
              ...
              size="lg"
              className="group gradient-primary hover:opacity-90 text-primary-foreground px-16 py-6 text-xl font-bold shadow-2xl hover:shadow-3xl hover:scale-110 hover:-translate-y-2 transition-all duration-500 rounded-2xl relative overflow-hidden"
            >
            ...
            <Button 
              ...
              size="lg"
              className="group gradient-primary hover:opacity-90 text-primary-foreground px-16 py-6 text-xl font-semibold shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-110 hover:-translate-y-1 rounded-2xl relative overflow-hidden"
            >
