...
interface ProphecyFormExpandedProps {
  projectId: string;
  onCancel: () => void;
  prophecy?: Prophecy;
}

export function ProphecyFormExpanded({ projectId, onCancel, prophecy }: ProphecyFormExpandedProps) {
  const [formData, setFormData] = useState({
    // Basic Information
    name: prophecy?.name || '',
    nicknames: prophecy?.nicknames || '',
    title: prophecy?.title || '',
    aliases: prophecy?.aliases || '',
    race: prophecy?.race || '',
    ethnicity: prophecy?.ethnicity || '',
    class: prophecy?.class || '',
    profession: prophecy?.profession || '',
    occupation: prophecy?.occupation || '',
    age: prophecy?.age || '',
    birthdate: prophecy?.birthdate || '',
    zodiacSign: prophecy?.zodiacSign || '',
    role: prophecy?.role || '',
    
    // Physical Appearance
    physicalDescription: prophecy?.physicalDescription || '',
    height: prophecy?.height || '',
    weight: prophecy?.weight || '',
    build: prophecy?.build || '',
    bodyType: prophecy?.bodyType || '',
    facialFeatures: prophecy?.facialFeatures || '',
    eyes: prophecy?.eyes || '',
    eyeColor: prophecy?.eyeColor || '',
    hair: prophecy?.hair || '',
    hairColor: prophecy?.hairColor || '',
    hairStyle: prophecy?.hairStyle || '',
    facialHair: prophecy?.facialHair || '',
    skin: prophecy?.skin || '',
    skinTone: prophecy?.skinTone || '',
    complexion: prophecy?.complexion || '',
    scars: prophecy?.scars || '',
    tattoos: prophecy?.tattoos || '',
    piercings: prophecy?.piercings || '',
    birthmarks: prophecy?.birthmarks || '',
    distinguishingMarks: prophecy?.distinguishingMarks || '',
    attire: prophecy?.attire || '',
    clothingStyle: prophecy?.clothingStyle || '',
    accessories: prophecy?.accessories || '',
    posture: prophecy?.posture || '',
    gait: prophecy?.gait || '',
    gestures: prophecy?.gestures || '',
    mannerisms: prophecy?.mannerisms || '',
    
    // Core Prophecy Details
    description: prophecy?.description || '',
    prophecySummary: prophecy?.prophecySummary || '',
    oneLine: prophecy?.oneLine || '',
    
    // Personality
    personality: prophecy?.personality || '',
    personalityTraits: prophecy?.personalityTraits?.join(', ') || '',
    temperament: prophecy?.temperament || '',
    disposition: prophecy?.disposition || '',
    worldview: prophecy?.worldview || '',
    beliefs: prophecy?.beliefs || '',
    values: prophecy?.values || '',
    principles: prophecy?.principles || '',
    morals: prophecy?.morals || '',
    ethics: prophecy?.ethics || '',
    virtues: prophecy?.virtues || '',
    vices: prophecy?.vices || '',
    habits: prophecy?.habits || '',
    quirks: prophecy?.quirks || '',
    idiosyncrasies: prophecy?.idiosyncrasies || '',
    petPeeves: prophecy?.petPeeves || '',
    likes: prophecy?.likes || '',
    dislikes: prophecy?.dislikes || '',
    hobbies: prophecy?.hobbies || '',
    interests: prophecy?.interests || '',
    passions: prophecy?.passions || '',
    
    // Psychological Profile
    motivations: prophecy?.motivations || '',
    desires: prophecy?.desires || '',
    needs: prophecy?.needs || '',
    drives: prophecy?.drives || '',
    ambitions: prophecy?.ambitions || '',
    fears: prophecy?.fears || '',
    phobias: prophecy?.phobias || '',
    anxieties: prophecy?.anxieties || '',
    insecurities: prophecy?.insecurities || '',
    secrets: prophecy?.secrets || '',
    shame: prophecy?.shame || '',
    guilt: prophecy?.guilt || '',
    regrets: prophecy?.regrets || '',
    trauma: prophecy?.trauma || '',
    wounds: prophecy?.wounds || '',
    copingMechanisms: prophecy?.copingMechanisms || '',
    defenses: prophecy?.defenses || '',
    vulnerabilities: prophecy?.vulnerabilities || '',
    weaknesses: prophecy?.weaknesses || '',
    blindSpots: prophecy?.blindSpots || '',
    mentalHealth: prophecy?.mentalHealth || '',
    emotionalState: prophecy?.emotionalState || '',
    maturityLevel: prophecy?.maturityLevel || '',
    intelligenceType: prophecy?.intelligenceType || '',
    learningStyle: prophecy?.learningStyle || '',
    
    // Background & History
    background: prophecy?.background || '',
    backstory: prophecy?.backstory || '',
    origin: prophecy?.origin || '',
    upbringing: prophecy?.upbringing || '',
    childhood: prophecy?.childhood || '',
    familyHistory: prophecy?.familyHistory || '',
    socialClass: prophecy?.socialClass || '',
    economicStatus: prophecy?.economicStatus || '',
    education: prophecy?.education || '',
    academicHistory: prophecy?.academicHistory || '',
    formativeEvents: prophecy?.formativeEvents || '',
    lifeChangingMoments: prophecy?.lifeChangingMoments || '',
    personalStruggle: prophecy?.personalStruggle || '',
    challenges: prophecy?.challenges || '',
    achievements: prophecy?.achievements || '',
    failures: prophecy?.failures || '',
    losses: prophecy?.losses || '',
    victories: prophecy?.victories || '',
    reputation: prophecy?.reputation || '',
    
    // Abilities & Skills
    abilities: prophecy?.abilities?.join(', ') || '',
    skills: prophecy?.skills?.join(', ') || '',
    talents: prophecy?.talents?.join(', ') || '',
    expertise: prophecy?.expertise?.join(', ') || '',
    specialAbilities: prophecy?.specialAbilities || '',
    powers: prophecy?.powers || '',
    magicalAbilities: prophecy?.magicalAbilities || '',
    magicType: prophecy?.magicType || '',
    magicSource: prophecy?.magicSource || '',
    magicLimitations: prophecy?.magicLimitations || '',
    superpowers: prophecy?.superpowers || '',
    strengths: prophecy?.strengths || '',
    competencies: prophecy?.competencies || '',
    training: prophecy?.training || '',
    experience: prophecy?.experience || '',
    
    // Story Elements
    goals: prophecy?.goals || '',
    objectives: prophecy?.objectives || '',
    wants: prophecy?.wants || '',
    obstacles: prophecy?.obstacles || '',
    conflicts: prophecy?.conflicts || '',
    conflictSources: prophecy?.conflictSources || '',
    stakes: prophecy?.stakes || '',
    consequences: prophecy?.consequences || '',
    arc: prophecy?.arc || '',
    journey: prophecy?.journey || '',
    transformation: prophecy?.transformation || '',
    growth: prophecy?.growth || '',
    allies: prophecy?.allies || '',
    enemies: prophecy?.enemies || '',
    mentors: prophecy?.mentors || '',
    rivals: prophecy?.rivals || '',
    connectionToEvents: prophecy?.connectionToEvents || '',
    plotRelevance: prophecy?.plotRelevance || '',
    storyFunction: prophecy?.storyFunction || '',
    
    // Language & Communication
    languages: prophecy?.languages?.join(', ') || '',
    nativeLanguage: prophecy?.nativeLanguage || '',
    accent: prophecy?.accent || '',
    dialect: prophecy?.dialect || '',
    voiceDescription: prophecy?.voiceDescription || '',
    speechPatterns: prophecy?.speechPatterns || '',
    vocabulary: prophecy?.vocabulary || '',
    catchphrases: prophecy?.catchphrases || '',
    slang: prophecy?.slang || '',
    communicationStyle: prophecy?.communicationStyle || '',
    
    // Social & Cultural
    family: prophecy?.family || '',
    parents: prophecy?.parents || '',
    siblings: prophecy?.siblings || '',
    spouse: prophecy?.spouse || '',
    children: prophecy?.children || '',
    friends: prophecy?.friends || '',
    socialCircle: prophecy?.socialCircle || '',
    community: prophecy?.community || '',
    culture: prophecy?.culture || '',
    traditions: prophecy?.traditions || '',
    customs: prophecy?.customs || '',
    religion: prophecy?.religion || '',
    spirituality: prophecy?.spirituality || '',
    politicalViews: prophecy?.politicalViews || '',
    
    // Meta Information
    archetypes: prophecy?.archetypes?.join(', ') || '',
    tropes: prophecy?.tropes?.join(', ') || '',
    inspiration: prophecy?.inspiration || '',
    basedOn: prophecy?.basedOn || '',
    tags: prophecy?.tags?.join(', ') || '',
    genre: prophecy?.genre || '',
    proseVibe: prophecy?.proseVibe || '',
    narrativeRole: prophecy?.narrativeRole || '',
    prophecyType: prophecy?.prophecyType || '',
    importance: prophecy?.importance || '',
    screenTime: prophecy?.screenTime || '',
    firstAppearance: prophecy?.firstAppearance || '',
    lastAppearance: prophecy?.lastAppearance || '',
    
    // Writer's Notes
    notes: prophecy?.notes || '',
    development: prophecy?.development || '',
    evolution: prophecy?.evolution || '',
    alternatives: prophecy?.alternatives || '',
    unused: prophecy?.unused || '',
    research: prophecy?.research || '',
    references: prophecy?.references || '',
    mood: prophecy?.mood || '',
    theme: prophecy?.theme || '',
    symbolism: prophecy?.symbolism || '',
  });
  ...
  const createMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await fetch(`/api/projects/${projectId}/prophecys`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(data)
      });
      if (!response.ok) throw new Error('Failed to create prophecy');
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await fetch(`/api/prophecys/${prophecy?.id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(data)
      });
      if (!response.ok) throw new Error('Failed to update prophecy');
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['/api/projects', projectId, 'prophecys'] });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (prophecy) {
      ...
      // Generate ID for new prophecy
      const newProphecyData = {
        ...processedData,
        id: Date.now().toString(),
      };
      createMutation.mutate(newProphecyData);
    }
  };
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            {isLoading ? 'Saving...' : 'Save Prophecy'}
          </Button>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <Tabs defaultValue="identity" className="w-full">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="Prophecy's full name"
                    />
                  </div>
                  <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="A single sentence that captures the essence of this prophecy"
                    />
                  </div>
                  <div>
                    <Label htmlFor="description">Prophecy Description</Label>
                    <Textarea
                      id="description"
                      value={formData.description}
                      onChange={(e) => updateField('description', e.target.value)}
                      placeholder="Overall description of the prophecy"
                      rows={4}
                    />
                  </div>
                  <div>
                    <Label htmlFor="prophecySummary">Prophecy Summary</Label>
                    <Textarea
                      id="prophecySummary"
                      value={formData.prophecySummary}
                      onChange={(e) => updateField('prophecySummary', e.target.value)}
                      placeholder="A comprehensive summary of who this prophecy is"
                      rows={3}
                    />
                  </div>
                </div>
              ...
              <TabsContent value="personality" className="space-y-6">
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Describe the prophecy's overall personality, temperament, and worldview"
                    rows={4}
                  />
                </div>
              ...
              <TabsContent value="story" className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="arc">Prophecy Arc</Label>
                    <Textarea
                      id="arc"
                      value={formData.arc}
              ...
              <TabsContent value="meta" className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="major prophecy, love interest, comic relief"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Personal notes about this prophecy's development, inspiration, changes, etc."
                    rows={6}
                  />
                </div>
              </TabsContent>
