...
interface CreatureDetailAccordionProps {
  projectId: string;
  creature: Creature;
  onBack: () => void;
...
export function CreatureDetailAccordion({ 
  creature, 
  onBack, 
  onEdit, 
  onDelete 
}: CreatureDetailAccordionProps) {
  ...
  const sectionHasContent = (sectionId: string) => {
    ...
    return section.fields.some(field => {
      const value = (creature as any)[field.key];
      if (field.type === 'array') {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button onClick={() => onEdit(creature)} className="interactive-warm gap-2">
        ...
        <CardContent className="p-6">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              {creature.title && (
                <p className="text-lg text-muted-foreground mb-3 italic">"{creature.title}"</p>
              )}
