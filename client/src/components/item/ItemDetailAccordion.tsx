...
export function ItemDetailAccordion({ 
  item, 
  onBack, 
  onEdit, 
  onDelete 
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button onClick={() => onEdit(item)} className="interactive-warm gap-2">
        ...
        <CardContent className="p-6">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              {item.title && (
                <p className="text-lg text-muted-foreground mb-3 italic">"{item.title}"</p>
              )}
