...
interface TimelineEventGenerationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onGenerate: (generationOptions: TimelineEventGenerationOptions) => Promise<void>;
  isGenerating: boolean;
}

export interface TimelineEventGenerationOptions {
...
export function TimelineEventGenerationModal({ 
  isOpen, 
  onClose, 
  onGenerate, 
  isGenerating 
}: TimelineEventGenerationModalProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-4">
          <div>
            <Label htmlFor="timelineevent-type">TimelineEvent Type</Label>
            <Select value={timelineeventType} onValueChange={setTimelineEventType}>
              <SelectTrigger>
                <SelectValue placeholder="What kind of timelineevent?" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="protagonist">Protagonist</SelectItem>
                <SelectItem value="antagonist">Antagonist</SelectItem>
                <SelectItem value="supporting">Supporting TimelineEvent</SelectItem>
          ...
          <div>
            <Label htmlFor="archetype">TimelineEvent Archetype</Label>
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Any specific traits, background, or details you want this timelineevent to have..."
              rows={3}
            />
          </div>
          ...
          <div className="flex justify-between pt-4">
            ...
            <div className="flex gap-2">
              ...
              <Button 
                ...
                disabled={isGenerating || !timelineeventType}
