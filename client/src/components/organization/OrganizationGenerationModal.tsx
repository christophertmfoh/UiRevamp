...
interface OrganizationGenerationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onGenerate: (generationOptions: OrganizationGenerationOptions) => Promise<void>;
  isGenerating: boolean;
}

export interface OrganizationGenerationOptions {
...
export function OrganizationGenerationModal({ 
  isOpen, 
  onClose, 
  onGenerate, 
  isGenerating 
}: OrganizationGenerationModalProps) {
        ...
        <div className="space-y-4">
          <div>
            ...
            <Select value={organizationType} onValueChange={setOrganizationType}>
              <SelectTrigger>
                <SelectValue placeholder="What kind of organization?" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="protagonist">Protagonist</SelectItem>
                <SelectItem value="antagonist">Antagonist</SelectItem>
                <SelectItem value="supporting">Supporting Organization</SelectItem>
          ...
          <div>
            <Label htmlFor="archetype">Organization Archetype</Label>
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Any specific traits, background, or details you want this organization to have..."
              rows={3}
            />
          </div>
          ...
          <div className="flex justify-between pt-4">
            ...
            <div className="flex gap-2">
              ...
              <Button 
                ...
                disabled={isGenerating || !organizationType}
