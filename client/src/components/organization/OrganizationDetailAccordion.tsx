...
interface OrganizationDetailAccordionProps {
  projectId: string;
...
export function OrganizationDetailAccordion({ 
  organization, 
  onBack, 
  onEdit, 
  onDelete 
}: OrganizationDetailAccordionProps) {
  ...
  const sectionHasContent = (sectionId: string) => {
    ...
    return section.fields.some(field => {
      const value = (organization as any)[field.key];
      if (field.type === 'array') {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button onClick={() => onEdit(organization)} className="interactive-warm gap-2">
        ...
        <CardContent className="p-6">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              {organization.title && (
                <p className="text-lg text-muted-foreground mb-3 italic">"{organization.title}"</p>
              )}
