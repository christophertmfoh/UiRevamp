...
interface LanguageDetailAccordionProps {
  projectId: string;
  language: Language;
  onBack: () => void;
...
export function LanguageDetailAccordion({ 
  language, 
  onBack, 
  onEdit, 
  onDelete 
}: LanguageDetailAccordionProps) {
  ...
  const sectionHasContent = (sectionId: string) => {
    ...
    return section.fields.some(field => {
      const value = (language as any)[field.key];
      if (field.type === 'array') {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button onClick={() => onEdit(language)} className="interactive-warm gap-2">
        ...
        <CardContent className="p-6">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              {language.title && (
                <p className="text-lg text-muted-foreground mb-3 italic">"{language.title}"</p>
              )}
