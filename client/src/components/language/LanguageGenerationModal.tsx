...
interface LanguageGenerationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onGenerate: (generationOptions: LanguageGenerationOptions) => Promise<void>;
...
export function LanguageGenerationModal({ 
  isOpen, 
  onClose, 
  onGenerate, 
  isGenerating 
}: LanguageGenerationModalProps) {
      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-4">
          <div>
            ...
            <Select value={languageType} onValueChange={setLanguageType}>
              <SelectTrigger>
                <SelectValue placeholder="What kind of language?" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="protagonist">Protagonist</SelectItem>
                <SelectItem value="antagonist">Antagonist</SelectItem>
                <SelectItem value="supporting">Supporting Language</SelectItem>
          ...
          <div>
            <Label htmlFor="archetype">Language Archetype</Label>
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Any specific traits, background, or details you want this language to have..."
              rows={3}
            />
          </div>
          ...
          <div className="flex justify-between pt-4">
            ...
            <div className="flex gap-2">
              ...
              <Button 
                ...
                disabled={isGenerating || !languageType}
