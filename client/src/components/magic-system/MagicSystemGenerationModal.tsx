...
interface MagicSystemGenerationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onGenerate: (generationOptions: MagicSystemGenerationOptions) => Promise<void>;
  isGenerating: boolean;
}

export interface MagicSystemGenerationOptions {
  magicsystemType: string;
  role: string;
  customPrompt: string;
  personality: string;
  archetype: string;
...
export function MagicSystemGenerationModal({ 
  isOpen, 
  onClose, 
  onGenerate, 
  isGenerating 
}: MagicSystemGenerationModalProps) {
  const [magicsystemType, setMagicSystemType] = useState('');
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-4">
          <div>
            <Label htmlFor="magicsystem-type">MagicSystem Type</Label>
            <Select value={magicsystemType} onValueChange={setMagicSystemType}>
              <SelectTrigger>
                <SelectValue placeholder="What kind of magicsystem?" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="protagonist">Protagonist</SelectItem>
                <SelectItem value="antagonist">Antagonist</SelectItem>
                <SelectItem value="supporting">Supporting MagicSystem</SelectItem>
          ...
          <div>
            <Label htmlFor="archetype">MagicSystem Archetype</Label>
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Any specific traits, background, or details you want this magicsystem to have..."
              rows={3}
            />
          </div>
          ...
          <div className="flex justify-between pt-4">
            ...
            <div className="flex gap-2">
              ...
              <Button 
                ...
                disabled={isGenerating || !magicsystemType}
