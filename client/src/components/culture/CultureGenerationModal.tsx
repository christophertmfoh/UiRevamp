...
interface CultureGenerationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onGenerate: (generationOptions: CultureGenerationOptions) => Promise<void>;
...
export function CultureGenerationModal({ 
  isOpen, 
  onClose, 
  onGenerate, 
  isGenerating 
}: CultureGenerationModalProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-4">
          <div>
            <Label htmlFor="culture-type">Culture Type</Label>
            <Select value={cultureType} onValueChange={setCultureType}>
              <SelectTrigger>
                <SelectValue placeholder="What kind of culture?" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="protagonist">Protagonist</SelectItem>
                <SelectItem value="antagonist">Antagonist</SelectItem>
                <SelectItem value="supporting">Supporting Culture</SelectItem>
          ...
          <div>
            <Label htmlFor="archetype">Culture Archetype</Label>
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Any specific traits, background, or details you want this culture to have..."
              rows={3}
            />
          </div>
          ...
          <div className="flex justify-between pt-4">
            ...
            <div className="flex gap-2">
              ...
              <Button 
                ...
                disabled={isGenerating || !cultureType}
