...
interface FactionDetailAccordionProps {
  projectId: string;
  faction: Faction;
  onBack: () => void;
...
export function FactionDetailAccordion({ 
  faction, 
  onBack, 
  onEdit, 
  onDelete 
}: FactionDetailAccordionProps) {
  ...
  const sectionHasContent = (sectionId: string) => {
    ...
    return section.fields.some(field => {
      const value = (faction as any)[field.key];
      if (field.type === 'array') {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button onClick={() => onEdit(faction)} className="interactive-warm gap-2">
        ...
        <CardContent className="p-6">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              {faction.title && (
                <p className="text-lg text-muted-foreground mb-3 italic">"{faction.title}"</p>
              )}
