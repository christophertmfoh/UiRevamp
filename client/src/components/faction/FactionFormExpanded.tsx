...
export function FactionFormExpanded({ projectId, onCancel, faction }: FactionFormExpandedProps) {
  const [formData, setFormData] = useState({
    // Basic Information
    name: faction?.name || '',
    nicknames: faction?.nicknames || '',
    title: faction?.title || '',
    aliases: faction?.aliases || '',
    race: faction?.race || '',
    ethnicity: faction?.ethnicity || '',
    class: faction?.class || '',
    profession: faction?.profession || '',
    occupation: faction?.occupation || '',
    age: faction?.age || '',
    birthdate: faction?.birthdate || '',
    zodiacSign: faction?.zodiacSign || '',
    role: faction?.role || '',
    
    // Physical Appearance
    physicalDescription: faction?.physicalDescription || '',
    height: faction?.height || '',
    weight: faction?.weight || '',
    build: faction?.build || '',
    bodyType: faction?.bodyType || '',
    facialFeatures: faction?.facialFeatures || '',
    eyes: faction?.eyes || '',
    eyeColor: faction?.eyeColor || '',
    hair: faction?.hair || '',
    hairColor: faction?.hairColor || '',
    hairStyle: faction?.hairStyle || '',
    facialHair: faction?.facialHair || '',
    skin: faction?.skin || '',
    skinTone: faction?.skinTone || '',
    complexion: faction?.complexion || '',
    scars: faction?.scars || '',
    tattoos: faction?.tattoos || '',
    piercings: faction?.piercings || '',
    birthmarks: faction?.birthmarks || '',
    distinguishingMarks: faction?.distinguishingMarks || '',
    attire: faction?.attire || '',
    clothingStyle: faction?.clothingStyle || '',
    accessories: faction?.accessories || '',
    posture: faction?.posture || '',
    gait: faction?.gait || '',
    gestures: faction?.gestures || '',
    mannerisms: faction?.mannerisms || '',
    
    // Core Faction Details
    description: faction?.description || '',
    factionSummary: faction?.factionSummary || '',
    oneLine: faction?.oneLine || '',
    ...
    morals: faction?.morals || '',
    ethics: faction?.ethics || '',
    virtues: faction?.virtues || '',
    vices: faction?.vices || '',
    habits: faction?.habits || '',
    quirks: faction?.quirks || '',
    idiosyncrasies: faction?.idiosyncrasies || '',
    petPeeves: faction?.petPeeves || '',
    likes: faction?.likes || '',
    dislikes: faction?.dislikes || '',
    hobbies: faction?.hobbies || '',
    interests: faction?.interests || '',
    passions: faction?.passions || '',
    
    // Psychological Profile
    motivations: faction?.motivations || '',
    desires: faction?.desires || '',
    needs: faction?.needs || '',
    drives: faction?.drives || '',
    ambitions: faction?.ambitions || '',
    fears: faction?.fears || '',
    phobias: faction?.phobias || '',
    anxieties: faction?.anxieties || '',
    insecurities: faction?.insecurities || '',
    secrets: faction?.secrets || '',
    shame: faction?.shame || '',
    guilt: faction?.guilt || '',
    regrets: faction?.regrets || '',
    trauma: faction?.trauma || '',
    wounds: faction?.wounds || '',
    copingMechanisms: faction?.copingMechanisms || '',
    defenses: faction?.defenses || '',
    vulnerabilities: faction?.vulnerabilities || '',
    weaknesses: faction?.weaknesses || '',
    blindSpots: faction?.blindSpots || '',
    mentalHealth: faction?.mentalHealth || '',
    emotionalState: faction?.emotionalState || '',
    maturityLevel: faction?.maturityLevel || '',
    intelligenceType: faction?.intelligenceType || '',
    learningStyle: faction?.learningStyle || '',
    
    // Background & History
    background: faction?.background || '',
    backstory: faction?.backstory || '',
    origin: faction?.origin || '',
    upbringing: faction?.upbringing || '',
    childhood: faction?.childhood || '',
    familyHistory: faction?.familyHistory || '',
    socialClass: faction?.socialClass || '',
    economicStatus: faction?.economicStatus || '',
    education: faction?.education || '',
    academicHistory: faction?.academicHistory || '',
    formativeEvents: faction?.formativeEvents || '',
    lifeChangingMoments: faction?.lifeChangingMoments || '',
    personalStruggle: faction?.personalStruggle || '',
    challenges: faction?.challenges || '',
    achievements: faction?.achievements || '',
    failures: faction?.failures || '',
    losses: faction?.losses || '',
    victories: faction?.victories || '',
    reputation: faction?.reputation || '',
    
    // Abilities & Skills
    abilities: faction?.abilities?.join(', ') || '',
    skills: faction?.skills?.join(', ') || '',
    talents: faction?.talents?.join(', ') || '',
    expertise: faction?.expertise?.join(', ') || '',
    specialAbilities: faction?.specialAbilities || '',
    powers: faction?.powers || '',
    magicalAbilities: faction?.magicalAbilities || '',
    magicType: faction?.magicType || '',
    magicSource: faction?.magicSource || '',
    magicLimitations: faction?.magicLimitations || '',
    superpowers: faction?.superpowers || '',
    strengths: faction?.strengths || '',
    competencies: faction?.competencies || '',
    training: faction?.training || '',
    ...
    wants: faction?.wants || '',
    obstacles: faction?.obstacles || '',
    conflicts: faction?.conflicts || '',
    conflictSources: faction?.conflictSources || '',
    stakes: faction?.stakes || '',
    consequences: faction?.consequences || '',
    arc: faction?.arc || '',
    journey: faction?.journey || '',
    transformation: faction?.transformation || '',
    growth: faction?.growth || '',
    allies: faction?.allies || '',
    enemies: faction?.enemies || '',
    mentors: faction?.mentors || '',
    rivals: faction?.rivals || '',
    connectionToEvents: faction?.connectionToEvents || '',
    plotRelevance: faction?.plotRelevance || '',
    storyFunction: faction?.storyFunction || '',
    
    // Language & Communication
    languages: faction?.languages?.join(', ') || '',
    nativeLanguage: faction?.nativeLanguage || '',
    accent: faction?.accent || '',
    dialect: faction?.dialect || '',
    voiceDescription: faction?.voiceDescription || '',
    speechPatterns: faction?.speechPatterns || '',
    vocabulary: faction?.vocabulary || '',
    catchphrases: faction?.catchphrases || '',
    slang: faction?.slang || '',
    communicationStyle: faction?.communicationStyle || '',
    
    // Social & Cultural
    family: faction?.family || '',
    parents: faction?.parents || '',
    siblings: faction?.siblings || '',
    spouse: faction?.spouse || '',
    children: faction?.children || '',
    friends: faction?.friends || '',
    socialCircle: faction?.socialCircle || '',
    community: faction?.community || '',
    culture: faction?.culture || '',
    traditions: faction?.traditions || '',
    customs: faction?.customs || '',
    religion: faction?.religion || '',
    spirituality: faction?.spirituality || '',
    politicalViews: faction?.politicalViews || '',
    
    // Meta Information
    archetypes: faction?.archetypes?.join(', ') || '',
    tropes: faction?.tropes?.join(', ') || '',
    inspiration: faction?.inspiration || '',
    basedOn: faction?.basedOn || '',
    ...
    screenTime: faction?.screenTime || '',
    firstAppearance: faction?.firstAppearance || '',
    lastAppearance: faction?.lastAppearance || '',
    
    // Writer's Notes
    notes: faction?.notes || '',
    development: faction?.development || '',
    evolution: faction?.evolution || '',
    alternatives: faction?.alternatives || '',
    unused: faction?.unused || '',
    research: faction?.research || '',
    references: faction?.references || '',
    mood: faction?.mood || '',
    theme: faction?.theme || '',
    symbolism: faction?.symbolism || '',
  });
  ...
  const createMutation = useMutation({
    mutationFn: async (data: any) => {
      const response = await fetch(`/api/projects/${projectId}/factions`, {
        method: 'POST',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (faction) {
      ...
      // Generate ID for new faction
      const newFactionData = {
        ...processedData,
        id: Date.now().toString(),
      };
      createMutation.mutate(newFactionData);
    }
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <Tabs defaultValue="identity" className="w-full">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="A single sentence that captures the essence of this faction"
                    />
                  </div>
                  <div>
                    <Label htmlFor="description">Faction Description</Label>
                    <Textarea
                      id="description"
                      value={formData.description}
                      onChange={(e) => updateField('description', e.target.value)}
                      placeholder="Overall description of the faction"
                      rows={4}
                    />
                  </div>
                  <div>
                    <Label htmlFor="factionSummary">Faction Summary</Label>
                    <Textarea
                      id="factionSummary"
                      value={formData.factionSummary}
                      onChange={(e) => updateField('factionSummary', e.target.value)}
                      placeholder="A comprehensive summary of who this faction is"
                      rows={3}
                    />
                  </div>
                </div>
              ...
              <TabsContent value="personality" className="space-y-6">
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Describe the faction's overall personality, temperament, and worldview"
                    rows={4}
                  />
                </div>
              ...
              <TabsContent value="story" className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="arc">Faction Arc</Label>
                    <Textarea
                      id="arc"
                      value={formData.arc}
              ...
              <TabsContent value="meta" className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Personal notes about this faction's development, inspiration, changes, etc."
                    rows={6}
                  />
                </div>
              </TabsContent>
