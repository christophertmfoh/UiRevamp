...
export function LocationUnifiedView({ 
  ...
  const processDataForSave = (data: Location) => {
    ...
    if (location.portraits) {
      dataToSave.portraits = location.portraits;
    }
  ...
  const handleImageGenerated = (imageUrl: string) => {
    // Update location with new image, preserving portraits
    const updatedData = { 
      ...formData, 
      imageUrl,
      portraits: location.portraits || [] // Preserve existing portraits
    };
  ...
  const handleImageUploaded = (imageUrl: string) => {
    // Update location with uploaded image, preserving portraits
    const updatedData = { 
      ...formData, 
      imageUrl,
      portraits: location.portraits || [] // Preserve existing portraits
