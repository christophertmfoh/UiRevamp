...
interface ThemeGenerationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onGenerate: (generationOptions: ThemeGenerationOptions) => Promise<void>;
...
export function ThemeGenerationModal({ 
  isOpen, 
  onClose, 
  onGenerate, 
  isGenerating 
}: ThemeGenerationModalProps) {
        ...
        <div className="space-y-4">
          <div>
            ...
            <Select value={themeType} onValueChange={setThemeType}>
              <SelectTrigger>
                <SelectValue placeholder="What kind of theme?" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="protagonist">Protagonist</SelectItem>
                <SelectItem value="antagonist">Antagonist</SelectItem>
                <SelectItem value="supporting">Supporting Theme</SelectItem>
          ...
          <div>
            <Label htmlFor="archetype">Theme Archetype</Label>
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Any specific traits, background, or details you want this theme to have..."
              rows={3}
            />
          </div>
          ...
          <div className="flex justify-between pt-4">
            ...
            <div className="flex gap-2">
              ...
              <Button 
                ...
                disabled={isGenerating || !themeType}
