  ...
  return (
    <div className="min-h-screen relative transition-all duration-300 overflow-hidden bg-gradient-to-br from-stone-50 via-amber-50/20 to-emerald-50/10 dark:from-stone-950 dark:via-stone-900 dark:to-stone-950">
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-4">
                ...
                <Button 
                  ...
                  className="group bg-gradient-to-r from-emerald-600 via-stone-600 to-amber-700 hover:from-emerald-500 hover:via-stone-500 hover:to-amber-600 text-foreground px-6 py-2 font-semibold shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-110 hover:-translate-y-1 rounded-2xl relative overflow-hidden"
                >
                ...
                <Button 
                  onClick={onLogout}
                  className="group bg-gradient-to-r from-emerald-600 via-stone-600 to-amber-700 hover:from-emerald-500 hover:via-stone-500 hover:to-amber-600 text-foreground px-4 py-2 font-semibold shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-0.5 rounded-2xl relative overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-10">
            <div className="space-y-10">
              <div className="inline-flex items-center space-x-3 px-4 py-2 rounded-full glass-card dark:bg-stone-900/30 border border-stone-400/50 dark:border-border/50 shadow-md dark:shadow-none">
              ...
              <div className="flex flex-col sm:flex-row gap-6 pt-6">
                <Button 
                  ...
                  className="group gradient-primary text-foreground px-10 py-5 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-110 hover:-translate-y-1 hover:brightness-110 rounded-2xl relative overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  <span className="relative z-10 flex items-center">
          ...
          <div className="lg:col-span-5">
            <div className="glass-card dark:bg-card/40 backdrop-blur-xl rounded-[2rem] p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] relative overflow-hidden border border-border/30 dark:border-border/20">
              ...
              <div className="relative z-10 text-center space-y-6">
                <div className="w-20 h-20 bg-gradient-to-br from-emerald-600 via-stone-600 to-amber-700 rounded-3xl flex items-center justify-center mx-auto shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-110 hover:rotate-3">
                  <PenTool className="w-10 h-10 text-foreground" />
                </div>
                      ...
                      <div
                        ...
                        className={`p-5 rounded-2xl transition-all duration-700 cursor-pointer group ${
                          isActive 
                            ...
                            : 'glass-card dark:bg-card/30 border border-border/50 dark:border-border/30 hover:bg-gradient-to-br hover:from-stone-50/80 hover:to-emerald-50/60 dark:hover:from-stone-900/30 dark:hover:to-emerald-900/20 hover:border-stone-400/60 dark:hover:border-border/40 hover:scale-105 hover:shadow-lg'
                        }`}
                      >
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-8 py-24">
        <div className="text-center space-y-16">
          <div className="space-y-6">
            <Badge className="glass-card dark:bg-stone-900/50 text-stone-900 dark:text-stone-100 border-stone-400/60 dark:border-border font-bold backdrop-blur-md shadow-md dark:shadow-lg">
              ...
              {processSteps.map((step, index) => {
                ...
                return (
                  <div key={index} className="text-center space-y-4 relative group">
                    ...
                    <div className="w-28 h-28 glass-card dark:bg-card/80 backdrop-blur-sm rounded-3xl flex items-center justify-center mx-auto shadow-lg dark:shadow-xl border border-stone-400/40 dark:border-border/50 group-hover:shadow-2xl group-hover:scale-110 group-hover:-translate-y-2 transition-all duration-500 cursor-pointer relative z-10 group-hover:rotate-3">
        ...
        <div className="text-center space-y-16">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {trustIndicators.map((indicator, index) => {
              ...
              return (
                <Card key={index} className="group glass-card dark:bg-card/90 backdrop-blur-lg border-border/60 dark:border-border/50 hover:shadow-2xl hover:shadow-emerald-200/20 dark:hover:shadow-emerald-900/10 transition-all duration-500 hover:scale-105 hover:-translate-y-2 cursor-pointer overflow-hidden relative">
            ...
            <div className="group text-center space-y-6 p-8 rounded-3xl bg-white/50 dark:bg-card/50 backdrop-blur-sm border border-border/50 dark:border-border/20 hover:shadow-2xl hover:shadow-emerald-200/20 dark:hover:shadow-emerald-900/10 transition-all duration-500 hover:scale-105 hover:-translate-y-2 relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6">
                <div className="w-20 h-20 bg-gradient-to-br from-emerald-600 via-stone-600 to-amber-700 rounded-3xl flex items-center justify-center mx-auto shadow-xl group-hover:shadow-2xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                  <CheckCircle className="w-10 h-10 text-foreground group-hover:scale-110 transition-transform duration-300" />
                </div>
            ...
            <div className="group text-center space-y-6 p-8 rounded-3xl bg-white/50 dark:bg-card/50 backdrop-blur-sm border border-border/50 dark:border-border/20 hover:shadow-2xl hover:shadow-emerald-200/20 dark:hover:shadow-emerald-900/10 transition-all duration-500 hover:scale-105 hover:-translate-y-2 relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6">
                <div className="w-20 h-20 bg-gradient-to-br from-stone-500 via-emerald-600 to-amber-700 dark:from-stone-600 dark:via-emerald-700 dark:to-amber-800 rounded-3xl flex items-center justify-center mx-auto shadow-xl group-hover:shadow-2xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                  <TrendingUp className="w-10 h-10 text-foreground group-hover:scale-110 transition-transform duration-300" />
                </div>
            ...
            <div className="group text-center space-y-6 p-8 rounded-3xl bg-white/50 dark:bg-card/50 backdrop-blur-sm border border-border/50 dark:border-border/20 hover:shadow-2xl hover:shadow-emerald-200/20 dark:hover:shadow-emerald-900/10 transition-all duration-500 hover:scale-105 hover:-translate-y-2 relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6">
                <div className="w-20 h-20 bg-gradient-to-br from-amber-600 via-stone-600 to-emerald-700 dark:from-amber-700 dark:via-stone-700 dark:to-emerald-800 rounded-3xl flex items-center justify-center mx-auto shadow-xl group-hover:shadow-2xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                  <Award className="w-10 h-10 text-foreground group-hover:scale-110 transition-transform duration-300" />
                </div>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-8 py-32">
        <div className="relative overflow-hidden rounded-[3rem] bg-gradient-to-br from-stone-50 via-emerald-50/80 to-amber-50/60 dark:from-slate-800 dark:via-slate-700 dark:to-slate-800 border border-border/50 dark:border-border/50 shadow-2xl">
          {/* Background texture */}
          ...
          <div className="relative z-10 text-center space-y-12 p-16">
            ...
            <div className="flex flex-col sm:flex-row gap-8 justify-center">
              <Button 
                onClick={() => onNewProject()}
                size="lg"
                className="group bg-gradient-to-r from-emerald-600 via-stone-600 to-amber-700 hover:from-emerald-700 hover:via-stone-700 hover:to-amber-800 dark:from-emerald-500 dark:via-stone-500 dark:to-amber-600 dark:hover:from-emerald-600 dark:hover:via-stone-600 dark:hover:to-amber-700 text-foreground px-16 py-6 text-xl font-bold shadow-2xl hover:shadow-3xl hover:scale-110 hover:-translate-y-2 transition-all duration-500 rounded-2xl relative overflow-hidden"
              >
              ...
              <Button 
                onClick={() => onNavigate('projects')}
                size="lg"
                className="group bg-gradient-to-r from-emerald-600 via-stone-600 to-amber-700 hover:from-emerald-700 hover:via-stone-700 hover:to-amber-800 dark:from-emerald-500 dark:via-stone-500 dark:to-amber-600 dark:hover:from-emerald-600 dark:hover:via-stone-600 dark:hover:to-amber-700 text-foreground px-16 py-6 text-xl font-semibold shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-110 hover:-translate-y-1 rounded-2xl relative overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <span className="relative z-10 flex items-center">
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-border/50 dark:border-border/50 py-20 px-8 bg-gradient-to-t from-stone-50/30 to-transparent dark:from-slate-900/50 dark:to-transparent">
        <div className="max-w-7xl mx-auto text-center space-y-8">
          <div className="flex items-center justify-center space-x-4 group cursor-pointer">
            <div className="w-14 h-14 bg-gradient-to-br from-emerald-600 via-stone-600 to-amber-700 rounded-2xl flex items-center justify-center shadow-xl group-hover:shadow-2xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
              <Feather className="w-7 h-7 text-foreground group-hover:scale-110 transition-transform duration-300" />
            </div>
